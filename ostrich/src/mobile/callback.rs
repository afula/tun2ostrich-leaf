...
///
/// -keep class com.ostrich.and.aostrich.** { *; }
///
...
/// #[no_mangle]
/// pub unsafe extern "system" fn Java_com_ostrich_and_aostrich_SimpleVpnService_setProtectSocketCallback(
///     mut env: JNIEnv,
///     class: JClass,
///     name: JString,
/// ) {
...
///         ostrich::mobile::callback::android::set_protect_socket_callback(class_g, name);
///     }
/// }
///
/// #[allow(non_snake_case)]
...
///     ostrich::mobile::callback::android::set_jvm(vm);
///     JNI_VERSION_1_6
/// }
///
/// #[allow(non_snake_case)]
...
///     ostrich::mobile::callback::android::unset_protect_socket_callback();
///     ostrich::mobile::callback::android::unset_jvm();
/// }
